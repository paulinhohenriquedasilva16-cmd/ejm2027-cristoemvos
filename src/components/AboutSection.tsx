      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="font-body text-muted-foreground text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            ...
            Um momento de avivamento genuíno onde jovens de todo o Brasil se reúnem em uma 
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              title: "Comunhão",
              description:
                "Organizado pela Igreja Cristo em Vós, sob a liderança do Pr. Pedro Vitorino, fundada pelo Pr. Alberi.",
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
