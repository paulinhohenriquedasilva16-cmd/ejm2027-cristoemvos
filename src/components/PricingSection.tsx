    ...
    <section id="inscricao" className="section-padding bg-background">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="rounded-3xl border-2 border-primary/30 bg-muted p-8 md:p-12 text-center"
        ...
        >
          ...
          <div className="mb-8">
            <span className="font-display text-5xl md:text-7xl gradient-text">R$ 599</span>
            <span className="font-display text-2xl md:text-3xl gradient-text">,99</span>
          </div>
